        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-ink/75">
              <li>
                <Link to="/shemaghs" className="hover:text-gold-deep">
                  Shemaghs
                </Link>
              </li>
              <li>
                <Link to="/niqabs" className="hover:text-gold-deep">
                  Niqabs
                </Link>
              </li>
              <li>
                <Link to="/kufis" className="hover:text-gold-deep">
                  Kufis
                </Link>
              </li>
              <li>
                <Link to="/gloves" className="hover:text-gold-deep">
                  Gloves
                </Link>
              </li>
              <li>
                <Link to="/honey" className="hover:text-gold-deep">
                  Honey
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-ink/75">
              ...
              <li>
                <Link to="/shipping" className="hover:text-gold-deep">
                  Shipping Policy
                </Link>
              </li>
              <li>
                <Link to="/returns" className="hover:text-gold-deep">
                  Returns & Refunds
                </Link>
              </li>
              <li>
