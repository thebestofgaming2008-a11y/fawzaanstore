...
export function StickyBuy({ label = "Add to cart", price }: { label?: string; price: string }) {
  return (
    <div className="md:hidden fixed bottom-0 inset-x-0 z-40 border-t border-border bg-ivory/95 backdrop-blur px-4 py-3 shadow-elegant">
      <button className="w-full flex items-center justify-between rounded-full bg-ink text-ivory px-5 py-3.5 text-sm font-semibold shadow-soft active:scale-[0.99] transition">
